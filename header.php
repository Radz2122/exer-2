...
<div id="page" class="site">
	...
	<h2 style="background-color:powderblue;">Voici une modification pour l'exercise 3</h2>
		<div class="site-branding">
			...
			$exer_2_description = get_bloginfo( 'description', 'display' );
			if ( $exer_2_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $exer_2_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
